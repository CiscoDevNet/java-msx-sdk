...
public class SitesApiTest {
    ...
    public void addDevicesToSiteTest() throws ApiException {
        UUID id = null;
        List<UUID> UUID = null;
        Site response = api.addDevicesToSite(id, UUID);
    ...
    public void addServicesToSiteTest() throws ApiException {
        UUID id = null;
        List<UUID> UUID = null;
        Site response = api.addServicesToSite(id, UUID);
    ...
    public void removeDevicesFromSiteTest() throws ApiException {
        UUID id = null;
        List<UUID> UUID = null;
        Site response = api.removeDevicesFromSite(id, UUID);
    ...
    public void removeServicesFromSiteTest() throws ApiException {
        UUID id = null;
        List<UUID> UUID = null;
        Site response = api.removeServicesFromSite(id, UUID);
