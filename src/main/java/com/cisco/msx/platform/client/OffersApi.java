...
public class OffersApi {
    ...
    /**
     * Build call for addOfferAssignments
     * @param id  (required)
     * @param UUID  (required)
     ...
     */
    public okhttp3.Call addOfferAssignmentsCall(UUID id, List<UUID> UUID, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = UUID;

        // create path and map variables
        String localVarPath = "/consume/api/v8/offers/{id}/assignments/add"
    ...
    private okhttp3.Call addOfferAssignmentsValidateBeforeCall(UUID id, List<UUID> UUID, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling addOfferAssignments(Async)");
        }
        
        // verify the required parameter 'UUID' is set
        if (UUID == null) {
            throw new ApiException("Missing the required parameter 'UUID' when calling addOfferAssignments(Async)");
        }
        

        okhttp3.Call localVarCall = addOfferAssignmentsCall(id, UUID, _callback);
        return localVarCall;
     ...
     */
    public List<CatalogAssignment> addOfferAssignments(UUID id, List<UUID> UUID) throws ApiException {
        ApiResponse<List<CatalogAssignment>> localVarResp = addOfferAssignmentsWithHttpInfo(id, UUID);
     ...
     */
    public ApiResponse<List<CatalogAssignment>> addOfferAssignmentsWithHttpInfo(UUID id, List<UUID> UUID) throws ApiException {
        okhttp3.Call localVarCall = addOfferAssignmentsValidateBeforeCall(id, UUID, null);
        Type localVarReturnType = new TypeToken<List<CatalogAssignment>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Assigns a product offer to one or more tenants. (asynchronously)
     * 
     * @param id  (required)
     * @param UUID  (required)
     ...
     */
    public okhttp3.Call addOfferAssignmentsAsync(UUID id, List<UUID> UUID, final ApiCallback<List<CatalogAssignment>> _callback) throws ApiException {

        okhttp3.Call localVarCall = addOfferAssignmentsValidateBeforeCall(id, UUID, _callback);
        Type localVarReturnType = new TypeToken<List<CatalogAssignment>>(){}.getType();
     ...
     */
    public okhttp3.Call getOffersPageCall(Integer page, Integer pageSize, UUID productId, UUID tenantId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOffersPageValidateBeforeCall(Integer page, Integer pageSize, UUID productId, UUID tenantId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getOffersPageCall(page, pageSize, productId, tenantId, _callback);
        return localVarCall;
     ...
     */
    public OffersPage getOffersPage(Integer page, Integer pageSize, UUID productId, UUID tenantId) throws ApiException {
        ApiResponse<OffersPage> localVarResp = getOffersPageWithHttpInfo(page, pageSize, productId, tenantId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OffersPage> getOffersPageWithHttpInfo(Integer page, Integer pageSize, UUID productId, UUID tenantId) throws ApiException {
        okhttp3.Call localVarCall = getOffersPageValidateBeforeCall(page, pageSize, productId, tenantId, null);
     ...
     */
    public okhttp3.Call getOffersPageAsync(Integer page, Integer pageSize, UUID productId, UUID tenantId, final ApiCallback<OffersPage> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOffersPageValidateBeforeCall(page, pageSize, productId, tenantId, _callback);
        Type localVarReturnType = new TypeToken<OffersPage>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for removeOfferAssignments
     * @param id  (required)
     * @param UUID  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call removeOfferAssignmentsCall(UUID id, List<UUID> UUID, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = UUID;

        // create path and map variables
        String localVarPath = "/consume/api/v8/offers/{id}/assignments/remove"
            .replaceAll("\\{" + "id" + "\\}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call removeOfferAssignmentsValidateBeforeCall(UUID id, List<UUID> UUID, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling removeOfferAssignments(Async)");
        }
        
        // verify the required parameter 'UUID' is set
        if (UUID == null) {
            throw new ApiException("Missing the required parameter 'UUID' when calling removeOfferAssignments(Async)");
        }
        

        okhttp3.Call localVarCall = removeOfferAssignmentsCall(id, UUID, _callback);
        return localVarCall;
     ...
     */
    public List<CatalogAssignment> removeOfferAssignments(UUID id, List<UUID> UUID) throws ApiException {
        ApiResponse<List<CatalogAssignment>> localVarResp = removeOfferAssignmentsWithHttpInfo(id, UUID);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<CatalogAssignment>> removeOfferAssignmentsWithHttpInfo(UUID id, List<UUID> UUID) throws ApiException {
        okhttp3.Call localVarCall = removeOfferAssignmentsValidateBeforeCall(id, UUID, null);
        Type localVarReturnType = new TypeToken<List<CatalogAssignment>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Unassigns a product offer from one or more tenants. (asynchronously)
     * 
     * @param id  (required)
     * @param UUID  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call removeOfferAssignmentsAsync(UUID id, List<UUID> UUID, final ApiCallback<List<CatalogAssignment>> _callback) throws ApiException {

        okhttp3.Call localVarCall = removeOfferAssignmentsValidateBeforeCall(id, UUID, _callback);
        Type localVarReturnType = new TypeToken<List<CatalogAssignment>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
