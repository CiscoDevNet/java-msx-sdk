...
KAKAPO - MSX SDK
- API version: 3.10.0
  - Build date: 2021-02-01T21:36:18.317728-05:00[America/New_York]
...
```groovy
compile "com.cisco.msx.platform:java-msx-sdk:3.10.0"
```
...
* `target/java-msx-sdk-3.10.0.jar`
* `target/lib/*.jar`
