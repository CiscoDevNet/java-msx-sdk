...
public class WorkflowsApi {
     ...
     */
    public String exportWorkflow(String id) throws ApiException {
        ApiResponse<String> localVarResp = exportWorkflowWithHttpInfo(id);
     ...
     */
    public ApiResponse<String> exportWorkflowWithHttpInfo(String id) throws ApiException {
     ...
     */
    public okhttp3.Call exportWorkflowAsync(String id, final ApiCallback<String> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call importWorkflowCall(List<UUID> tenantIds, Map<String, Object> requestBody, Boolean global, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call importWorkflowValidateBeforeCall(List<UUID> tenantIds, Map<String, Object> requestBody, Boolean global, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'tenantIds' is set
        if (tenantIds == null) {
            throw new ApiException("Missing the required parameter 'tenantIds' when calling importWorkflow(Async)");
        }
        ...
        okhttp3.Call localVarCall = importWorkflowCall(tenantIds, requestBody, global, _callback);
        return localVarCall;
     ...
     */
    public WorkflowMapping importWorkflow(List<UUID> tenantIds, Map<String, Object> requestBody, Boolean global) throws ApiException {
        ApiResponse<WorkflowMapping> localVarResp = importWorkflowWithHttpInfo(tenantIds, requestBody, global);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<WorkflowMapping> importWorkflowWithHttpInfo(List<UUID> tenantIds, Map<String, Object> requestBody, Boolean global) throws ApiException {
        okhttp3.Call localVarCall = importWorkflowValidateBeforeCall(tenantIds, requestBody, global, null);
     ...
     */
    public okhttp3.Call importWorkflowAsync(List<UUID> tenantIds, Map<String, Object> requestBody, Boolean global, final ApiCallback<WorkflowMapping> _callback) throws ApiException {

        okhttp3.Call localVarCall = importWorkflowValidateBeforeCall(tenantIds, requestBody, global, _callback);
        Type localVarReturnType = new TypeToken<WorkflowMapping>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call updateWorkflowCall(String id, Map<String, Object> requestBody, List<UUID> tenantId, Boolean global, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = requestBody;
        ...
        if (tenantId != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "tenantId", tenantId));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateWorkflowValidateBeforeCall(String id, Map<String, Object> requestBody, List<UUID> tenantId, Boolean global, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateWorkflowCall(id, requestBody, tenantId, global, _callback);
        return localVarCall;
     ...
     */
    public WorkflowMapping updateWorkflow(String id, Map<String, Object> requestBody, List<UUID> tenantId, Boolean global) throws ApiException {
        ApiResponse<WorkflowMapping> localVarResp = updateWorkflowWithHttpInfo(id, requestBody, tenantId, global);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<WorkflowMapping> updateWorkflowWithHttpInfo(String id, Map<String, Object> requestBody, List<UUID> tenantId, Boolean global) throws ApiException {
        okhttp3.Call localVarCall = updateWorkflowValidateBeforeCall(id, requestBody, tenantId, global, null);
        Type localVarReturnType = new TypeToken<WorkflowMapping>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateWorkflowAsync(String id, Map<String, Object> requestBody, List<UUID> tenantId, Boolean global, final ApiCallback<WorkflowMapping> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateWorkflowValidateBeforeCall(id, requestBody, tenantId, global, _callback);
        Type localVarReturnType = new TypeToken<WorkflowMapping>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
