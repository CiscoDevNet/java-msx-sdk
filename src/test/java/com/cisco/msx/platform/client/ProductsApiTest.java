...
public class ProductsApiTest {
     ...
     */
    @Test
    public void addProductAssignmentsTest() throws ApiException {
        UUID id = null;
        List<UUID> UUID = null;
        List<CatalogAssignment> response = api.addProductAssignments(id, UUID);
     ...
     */
    @Test
    public void removeProductAssignmentsTest() throws ApiException {
        UUID id = null;
        List<UUID> UUID = null;
        List<CatalogAssignment> response = api.removeProductAssignments(id, UUID);
